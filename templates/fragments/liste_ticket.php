...
<ul class="mt16">
    ...
    foreach($listeAttente as $id => $ticket){
        ...
        echo "$refProduit - $statut - $ouverture - <a href='index.php?controleur=afficher_ticket&idTicket=$id'>⇛</li>";
    }
    ?>
</ul>
...
<ul class="mt16">
    ...
    foreach($listeRepondu as $id => $ticket){
        ...
        $statut = $ticket->get("statut");
        $ouverture = $ticket->get("ouverture");
        echo "$refProduit - $statut - $ouverture - <a href='index.php?controleur=afficher_ticket&idTicket=$id'>⇛</a></li>";
    }
    ?>
</ul>
