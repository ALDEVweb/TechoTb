...
foreach($liste as $id => $ticket){
    ...
    <tr class="histo">
        ...
        <td class="w200 tdPop fs10 mrlauto txt-center d-none flex j-between a-center gap16"><div><?= $produit->get("design") ?><br><?= $ticket->getHTML("demande") ?><br><a href="index.php?controleur=afficher_ticket&idTicket=<?= $id ?>">Détail ⇛</a>
        <?php
