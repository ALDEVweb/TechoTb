...
<div class="mt40">
    <a href="index.php?controleur=afficher_client"><button id="client" class="btnPad">Créer un client</button></a>        

    <h5 class="fs18 mt40"></h5>
    <form class="encart mt40" action="index.php?controleur=afficher_form_vente" method="POST">
