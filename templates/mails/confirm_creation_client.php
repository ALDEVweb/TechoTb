...
<body>
    ...
    <p>Vous pouvez maintenant vous connecter avec vos identifiants en suivant ce lien : <a href="http://tickets.alaugier.mywebecom.ovh/index.php">Connexion</a></p><br>
