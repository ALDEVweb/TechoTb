    ...
    <body class="blue">
        ...
        <main class="w300 mrlauto">
            <div class="flex j-between a-center mt40">
                ...
                <a href="index.php"><button class="btnPad">Accueil</button></a>
            </div>
            <div class="flex j-between a-center mt40">
                <div>
                    <ul>
                ...
                <div id="containConfirm">
                    ...
                    <div id="confirm" class="encart d-none">
                        ...
                        <div class="flex j-around mt40">
                            ...
                            <a href="index.php?controleur=fermer_ticket&idTicket=<?= $idTicket ?>"><button class="btnPad">Oui</button></a>
                        </div>
                    </div>
                </div>
            </div>
            <p><?= $ticket->get("demande") ?></p>
            <form class="mt16" action="index.php?controleur=envoyer_message" method="POST">
