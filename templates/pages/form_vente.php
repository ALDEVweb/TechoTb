...
<?php include "templates/fragments/header.php"; ?>
    <main class="w300 mrlauto blue">
        ...
        <form class="encart mt40" action="index.php?controleur=enregistrer_vente" method="POST">
        <?php
            if($error == 1 && $clientInconnu == 1){
                echo "<p class='w200 mt4 mb16 fs12 red mrlauto'>Le client est inconnu, veuillez créer un nouveau client - <a href='index.php?controleur=afficher_client'><u>Créer un client</u></a></p>";
            }
        ?>
        <div class="w200 mrlauto">
            ...
            <div class="w200 mrlauto mt16 flex j-between a-center">
                ...
                <a class="fs12" href="index.php">Annuler</a>
            </div>
        </form>
    </main>
